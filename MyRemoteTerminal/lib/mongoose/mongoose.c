...
// #L5583 Modified        Old text:   return GetTickCount();
// #L5903 Modified        Old text:   
...
//// Modified: my_http_serve_file, 2022-08-15
void my_http_serve_file(struct mg_connection* c, struct mg_http_message* hm,
    const char* path,
...
//    return (0 == _stricmp(hm->uri.ptr, glob));
//}
