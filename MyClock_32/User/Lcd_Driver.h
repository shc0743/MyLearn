...
/******************************************************************************
//本程序适用与STM32F103C8
//    xiamianzhexieshijiade,buyaoxing
//              GND   电源地
//              VCC   接5V或3.3v电源
//              SCL   接PA5（SCL）
//              SDA   接PA7（SDA）
...
#define LCD_RS/*DC*/   	GPIO_Pin_1	//PB11--->>TFT --RS/DC
#define LCD_RST     	GPIO_Pin_0	//PB10--->>TFT --RST
#elif 0
#define LCD_SCL        	GPIO_Pin_1	// B1
#define LCD_SDA        	GPIO_Pin_0	// B0
#define LCD_CS        	GPIO_Pin_5  // A5

#define LCD_LED        	GPIO_Pin_4  // A4
#define LCD_RS/*DC*/   	GPIO_Pin_6	// A6
#define LCD_RST     	GPIO_Pin_7	// A7
#else
#define LCD_SCL        	GPIO_Pin_5	// A5
#define LCD_SDA        	GPIO_Pin_7	// A7
#define LCD_CS        	GPIO_Pin_4  // A4

#define LCD_LED        	GPIO_Pin_0  // B0
#define LCD_RS/*DC*/   	GPIO_Pin_1	// B1
#define LCD_RST     	GPIO_Pin_3	// B3
#endif
...
#else
//液晶控制口置1操作语句宏定义
#define	LCD_SCL_SET  	error
#define	LCD_SDA_SET  	error
#define	LCD_CS_SET  	MySPI_Stop()

#define	LCD_LED_SET  	LCD_CTRLB->BSRR=LCD_LED
#define	LCD_RS_SET  	LCD_CTRLB->BSRR=LCD_RS
#define	LCD_RST_SET  	LCD_CTRLB->BSRR=LCD_RST
//液晶控制口置0操作语句宏定义
#define	LCD_SCL_CLR  	error
#define	LCD_SDA_CLR  	error
#define	LCD_CS_CLR  	MySPI_Start()
