...
// include: /data/data/com.termux/files/usr/tmp/tmpzpyfeabf.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'tcs_app@emnative.data';
      var REMOTE_PACKAGE_BASE = 'tcs_app@emnative.data';
...
Module['FS_createPath']("/", "fonts", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_tcs_app@emnative.data');
      }
      Module['addRunDependency']('datafile_tcs_app@emnative.data');
    ...
    loadPackage({"files": [{"filename": "/fonts/DroidSans.ttf", "start": 0, "end": 2371712}], "remote_package_size": 2371712});

  })();

// end include: /data/data/com.termux/files/usr/tmp/tmpzpyfeabf.js
// include: /data/data/com.termux/files/usr/tmp/tmpkeyfwsxx.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /data/data/com.termux/files/usr/tmp/tmpkeyfwsxx.js
// include: /data/data/com.termux/files/usr/tmp/tmpue831dx9.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /data/data/com.termux/files/usr/tmp/tmpue831dx9.js
...
function findWasmBinary() {
    return locateFile('tcs_app@emnative.wasm');
}
...
function assignWasmExports(wasmExports) {
  Module['_startGame'] = _startGame = createExportWrapper('startGame', 0);
  Module['_stopGame'] = _stopGame = createExportWrapper('stopGame', 0);
